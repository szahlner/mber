...
parser = argparse.ArgumentParser(description='PyTorch Deep Deterministic Policy Gradient DDPG Args')
...
parser.add_argument('--lr-actor', type=float, default=0.001, metavar='G',
                    help='learning rate actor (default: 0.001)')
parser.add_argument('--lr-critic', type=float, default=0.001, metavar='G',
                    help='learning rate critic (default: 0.001)')
parser.add_argument('--batch-size', type=int, default=256, metavar='N',
                    help='batch size (default: 256)')
parser.add_argument('--hidden-size', type=int, default=256, metavar='N',
                    help='hidden size (default: 256)')
parser.add_argument("--expl-noise", type=float, default=0.2, metavar='N',
...
parser.add_argument('--rollout-min-epoch', type=int, default=1, metavar='N',
                    help='rollout min epoch (default: 20)')
parser.add_argument('--rollout-max-epoch', type=int, default=15, metavar='N',
...
parser.add_argument('--rollout-max-length', type=int, default=1, metavar='N',
