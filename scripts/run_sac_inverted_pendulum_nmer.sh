...
do
  python main_sac.py --env-name $env_name --target-entropy $target_entropy --num-steps $num_steps --start-steps $start_steps --nmer --updates-per-step $updates_per_step --seed $seed --eval-timesteps 250
done
