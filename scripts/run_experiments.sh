...
cp "./scripts/run_sac_ant_lcercc_0.sh" "./run_sac_ant_lcercc_0.sh"
cp "./scripts/run_sac_ant_lcercc_1.sh" "./run_sac_ant_lcercc_1.sh"
cp "./scripts/run_sac_ant_lcercc_2.sh" "./run_sac_ant_lcercc_2.sh"
...
cp "./scripts/run_sac_hopper_lcercc_0.sh" "./run_sac_hopper_lcercc_0.sh"
cp "./scripts/run_sac_hopper_lcercc_1.sh" "./run_sac_hopper_lcercc_1.sh"
cp "./scripts/run_sac_hopper_lcercc_2.sh" "./run_sac_hopper_lcercc_2.sh"
cp "./scripts/run_sac_hopper_lcerrm.sh" "./run_sac_hopper_lcerrm.sh"
cp "./scripts/run_sac_hopper_lcerrm_0.sh" "./run_sac_hopper_lcerrm_0.sh"
cp "./scripts/run_sac_hopper_lcerrm_1.sh" "./run_sac_hopper_lcerrm_1.sh"
cp "./scripts/run_sac_hopper_lcerrm_2.sh" "./run_sac_hopper_lcerrm_2.sh"
...
chmod +x "./run_sac_ant_lcercc_0.sh"
chmod +x "./run_sac_ant_lcercc_1.sh"
chmod +x "./run_sac_ant_lcercc_2.sh"
...
chmod +x "./run_sac_hopper_lcercc_0.sh"
chmod +x "./run_sac_hopper_lcercc_1.sh"
chmod +x "./run_sac_hopper_lcercc_2.sh"
chmod +x "./run_sac_hopper_lcerrm.sh"
chmod +x "./run_sac_hopper_lcerrm_0.sh"
chmod +x "./run_sac_hopper_lcerrm_1.sh"
chmod +x "./run_sac_hopper_lcerrm_2.sh"
